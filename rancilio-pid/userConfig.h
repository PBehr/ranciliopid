...
#define BREWDETECTION 2      // 0 = off; 1 = Software; 2 = Hardware
...
#define MQTT_TOPIC_PREFIX "custom/Kueche."  // topic will be "<MQTT_TOPIC_PREFIX><HOSTNAME>/<READING>"
//#define MQTT_SERVER_IP "192.168.178.26"       // IP-Address of locally installed mqtt server
#define MQTT_SERVER_IP ""       // IP-Address of locally installed mqtt server
#define MQTT_SERVER_PORT 1883    
// Wifi & Blynk 
#define HOSTNAME "RancilioTest"
#define AUTH "MdFtPJIM2I4yhBflg9tH6TlwLOV3pFAJ"
#define D_SSID "optimus"
#define PASS "em3pCnjT40"

// OTA
#define OTAHOST "RancilioTest"   // Name to be shown in ARUDINO IDE Port
